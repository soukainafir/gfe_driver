...
#include "csrpp.h"
#include "graph_csrpp.h"
#include "generated-GM/pagerank.h"
#include "library/interface.hpp"
#include "third-party/libcuckoo/cuckoohash_map.hh"

class graph_csrpp; // forward declaration
...
// Otherwise, use libcuckoo
    ...
    class CSRPP : public virtual UpdateInterface, public virtual LoaderInterface, public virtual GraphalyticsInterface {
    public:
    ...
    public:
        ...
        CSRPP(bool directed, int num_segments);
        /**
         * Initialise the graph instance
